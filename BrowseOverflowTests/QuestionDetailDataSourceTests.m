...
- (void)testDataInAnswerCellMatchAnswerProperties
{
    ...
    XCTAssertFalse(cell.acceptedLabel.hidden, @"Answer cell should indicate that answer is accepted");
}
...
- (void)testDataInSecondAnswerCellMatchSecondAnswerProperties
{
    ...
    XCTAssertTrue(secondAnswerCell.acceptedLabel.hidden, @"Answer cell should indicate that answer is not accepted");
